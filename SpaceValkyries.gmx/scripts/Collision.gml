...
test1 = 0
if(name0 == "obj_main_01" && name1 == "obj_ene_01") test1 = 1
else if(name0 == "obj_ene_01" && name1 == "obj_main_01") test1 =2
...
test = 0
if(name0 == "obj_main_missile_01" && name1 == "obj_ene_01") test = 1
else if(name0 == "obj_ene_01" && name1 == "obj_main_missle_01") test = 2
